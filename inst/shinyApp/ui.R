...
shinyUI(ui = tagList(
  ...
  navbarPage(id = "menu_bar",  position = "fixed-top",
             ...
             strong("metaboliteR"), # Main title name
             ...
             tabPanel("Home",
                      column(12, align="center",
                             ...
                             column(12, align="center",
                                    br(),
                                    h4(strong("To get started, click on the method you require.")),
                             )
                      )
             ),
             ...
             navbarMenu("Analytics",
                        ...
                        # ppca --------------------------------------------------------------------
                        tabPanel("PPCA/PPCCA",
                                 conditionalPanel(condition="input.PPCA_plot_tabs!='PPCA_steps'",
                                                  ...
                                                  sidebarPanel(width = 3,
                                                               ...
                                                               conditionalPanel(condition="input.PPCA_plot_tabs=='PPCA_data'",
                                                                                ...
                                                                                bsPopover("PPCA_data_tooltip", title="Metabolomic Data File",
                                                                                          content="Should consist of at least the Spectral Data from NMR/MS. If there are Covariates/Labels, it should be in the first few columns. This File Input only accepts .txt and .csv",
                                                                                          trigger = "hover"),
                                                                                radioButtons(inputId = 'PPCA_data_choice', label = NULL,
                                                                                ...
                                                                                hidden(textInput("PPCA_ignore_column", h4("Columns Ignored for Spectral Data:"), "", placeholder="Column number/names (e.g: 2,3,5 or 9.98,9.94,9.86)")),
                                                                                ...
                                                                                actionButton("PPCA_parameter_button", "Go to Model Specification",
                                                                                             width = "100%", class = "btn-default"),
                                                               ),

                                                               conditionalPanel(condition="input.PPCA_plot_tabs=='PPCA_specification'",

                                                                                actionButton("PPCA_data_button", "Go to PPCA Data Input",
                                                                                             width = "100%", class = "btn-default"),

                                                                                h3(helpText('Model Specifications:')),
                                                                                ...
                                                                                tags$h6("Click button to run the model using desired specifications:"),
                                                                                div(style="display:inline-block",
                                                                                    disabled(actionButton("PPCA_submit_para_btn", "Submit Model Specifications", class = "btn-primary")),
                                                                                ),
                                                                                div(style="display:inline-block",
                                                                                    strong(textOutput("PPCA_optimal_q")),
                                                                                ),
                                                                                p("Please input data first", id="PPCA_data_check_for_submit", style="color:red"),
                                                                                tags$hr(),

                                                               ),


                                                               conditionalPanel(condition="input.PPCA_plot_tabs!='PPCA_specification' & input.PPCA_plot_tabs!='PPCA_data' & input.PPCA_plot_tabs!='PPCA_steps'",
                                                                                # tags$br(),
                                                                                actionButton("PPCA_return_param", "Return to Model Specification",
                                                                                             width = "100%", class = "btn-default"),
                                 ...
                                 mainPanel(width = 9, id = "PPCA_main_layout",
                                           # Style for influence tab, PPCA tabs
                                           tags$style(HTML("
                                                .tabbable > .nav > li > a[data-value='PPCA_influence_plot'] {color:blue}
                                                .tabbable > .nav > li > a[data-value='PPCA_spectral'] {background-color:lightyellow}
                                                .tabbable > .nav > li > a[data-value='PPCA_covariates'] {background-color:lightyellow; color:blue}
                                                .tabbable > .nav > li > a[data-value='PPCA_labels'] {background-color:lightyellow}
                                                .tabbable > .nav > li[class=active] > a {background-color:grey; color:white}


                                                #PPCA_data_tabs li:nth-child(4) {float:right}
                                                #PPCA_data_tabs li > a[data-value='PPCA_original_data_table']{background-color:lightgrey}
                                                          ")),

                                           tabsetPanel(id = "PPCA_plot_tabs", selected = "PPCA_steps",

                                                       tabPanel("Quick Start", value = "PPCA_steps",
                                                                column(width = 6, offset = 0.5,
                                                                       ...
                                                                       h3(
                                                                         tags$div(
                                                                           tags$ol(
                                                                             tags$li("Enter your data in the 'PPCA Data' tab"),
                                                                             br(),
                                                                             tags$li("Specify the model parameters in the 'Model Specification' tab"),
                                                                             br(),
                                                                             tags$li("In the 'Model Specification' tab, click the 'SUBMIT MODEL SPECIFICATIONS' button for the model to run."),
                                                                             br(),
                                                                             tags$li("Once the model finishes running, plots will appear under the different plot tabs beside the 'Model Specification' tab."),
                                                                             br(),
                                                                             actionButton("PPCA_data_QS", "PPCA Data", class = "btn-default"),
                                                                             actionButton("PPCA_model_spec_QS", "Model Specification", class = "btn-default"),
                                                                           )
                                                                         )
                                                                       ),
                                                                       br(),
                                                                ...
                                                                column(width = 6, offset = 0.5,
                                                                       br(),
                                                                       h4(tags$u("Note: PPCA demo below, click play to animate")),
                                                                       sliderInput("PPCA_gif_slider", label=NULL, min = 0, max=218, value=0, ticks = FALSE,
                                                                                   animate = animationOptions(interval = 300)),
                                                                       hidden(imageOutput("PPCA_gif_demo")),
                                                                       br(),
                                                                       br(),
                                                                )
                                                       ...
                                                       tabPanel("PPCA Data", value = "PPCA_data",
                                                                ...
                                                                tabsetPanel(id = "PPCA_data_tabs",
                                                                            tabPanel(span("Spectral Data", title="Data from NMR or Mass Spectroscopy (MS). Please make sure: rows are samples/observations, columns are spectral bins"),
                                                                                     value = 'PPCA_spectral',
                                                                            ...
                                                                            tabPanel(span("Covariates Data", title="Sample attributes (eg: weight, gender, regions, etc)"),
                                                                                     ...
                                                                                     dataTableOutput("PPCA_covariates_data_table")
                                                                            ),
                                                                            ...
                                                                            tabPanel("Original Data",
                                                                                     value = "PPCA_original_data_table",
                                                                                     br(),
                                                                                     column(12,
                                                                                            column(3, "Covariates Highlighted Color", style = "background-color:lightblue; color:blue"),
                                                                                            column(3, "Group Labels Highlighted Color", style = "background-color:orange;"),
                                                                                            # column(3, "Columns Ignored Highlighted Color", style = "background-color:grey;color:white"),
                                                                                     ),
                                                                                     uiOutput("PPCA_original_data_table_UI")
                                                       ...
                                                       tabPanel("Model Specification", value = "PPCA_specification",
                                                                br(),
                                                                bsCollapse(id = "PPCA_desc", open = "PPCA/PPCCA Parameters Description",
                                                                           bsCollapsePanel("PPCA/PPCCA Parameters Description",

                                                                                           includeHTML("PPCA_desc_pd.html"),
                                                                                           style = "primary"),
                        ...
                        # mppca -------------------------------------------------------------------
                        tabPanel("MPPCA",
                                 conditionalPanel(condition="input.MPPCA_plot_tabs!='MPPCA_steps'",
                                                  sidebarPanel(width=3,
                                                               # tags$div("MPPCA",
                                                               ...
                                                               conditionalPanel(condition="input.MPPCA_plot_tabs=='MPPCA_data'",
                                                                                ...
                                                                                # MPPCA data inputs
                                                                                fileInput("MPPCA_input_file", h4("File input:", bsButton("MPPCA_data_tooltip", label = "",
                                                                                                                                         icon = icon("question"), size = "extra-small")),
                                                                                          multiple = F, accept = c("text/csv", "text/comma-separated-values, text/plain", ".csv"),
                                                                                          placeholder = "Enter Metabolomic Data Here"),
                                                                                bsPopover("MPPCA_data_tooltip", title="Metabolomic Data File",
                                                                                          content="Should consist of at least the Spectral Data from NMR/MS. If there are Labels, it should be in the first few columns. This File Input only accepts .txt and .csv",
                                                                                          trigger = "hover"),

                                                                                radioButtons(inputId = 'MPPCA_data_choice', label = NULL,
                                                                                             choiceNames =  c("Use Your Own Data", "Use Example Data"),
                                                                                             choiceValues = c(TRUE, FALSE),
                                                                                             selected = TRUE, inline = TRUE),
                                                                                ...
                                                                                helpText("When group labels are selected, they will appear in the 'Group Labels' tab"),
                                                                                hidden(textInput("MPPCA_ignore_column", h4("Columns Ignored for Spectral Data:"), "", placeholder="Column number/names (e.g: 2,3,5 or 9.98,9.94,9.86)")),
                                                                                ...
                                                                                tags$hr(),
                                                                                actionButton("MPPCA_parameter_button", "Go to Model Specification",
                                                                                             width = "100%", class = "btn-default"),
                                                               ),


                                                               conditionalPanel(condition="input.MPPCA_plot_tabs=='MPPCA_specification'",
                                                                                ...
                                                                                div(style="display:inline-block",
                                                                                    disabled(actionButton("MPPCA_submit_para_btn", "Submit Parameters", class = "btn-primary")),
                                                                                ),
                                                                                div(style="display:inline-block",
                                                                                ...
                                                                                p("Please input data first", id="MPPCA_data_check_for_submit", style="color:red"),

                                                                                tags$hr(),
                                                               ),

                                                               # Graph controls
                                                               conditionalPanel(condition="input.MPPCA_plot_tabs!='MPPCA_specification' & input.MPPCA_plot_tabs!='MPPCA_data' & input.MPPCA_plot_tabs!='MPPCA_steps'",
                                                                                # tags$br(),
                                                                                actionButton("MPPCA_return_param", "Return to Model Specification",
                                                                                             width = "100%", class = "btn-default"),
                                                                                h3(helpText('Graph Controls:'))
                                                               ),
                                 ...
                                 # MPCCA plots
                                 mainPanel(width = 9, id = "MPPCA_main_layout",

                                           # Style for MPPCA tabs
                                           tags$style(HTML("
                                                  .tabbable > .nav > li > a[data-value='MPPCA_spectral'] {background-color:lightyellow}
                                                  .tabbable > .nav > li > a[data-value='MPPCA_covariates'] {background-color:lightyellow; color:blue}
                                                  .tabbable > .nav > li > a[data-value='MPPCA_labels'] {background-color:lightyellow}
                                                  .tabbable > .nav > li[class=active] > a {background-color:grey; color:white}

                                                  #MPPCA_data_tabs li:nth-child(3) {float:right}
                                                  #MPPCA_data_tabs li > a[data-value='MPPCA_original_data_table']{background-color:lightgrey}
                                                        ")),



                                           tabsetPanel(id = "MPPCA_plot_tabs", selected = "MPPCA_steps",

                                                       tabPanel("Quick Start", value = "MPPCA_steps",
                                                                column(width = 6, offset = 0.5,
                                                                       br(),
                                                                       h1(strong(tags$u("Usage Guide:"))),
                                                                       h3(
                                                                         tags$div(
                                                                           tags$ol(
                                                                             tags$li("Enter your data in the 'MPPCA Data' tab"),
                                                                             br(),
                                                                             tags$li("Specify the model parameters in the 'Model Specification' tab"),
                                                                             br(),
                                                                             tags$li("In the 'Model Specification' tab, click the 'SUBMIT MODEL SPECIFICATIONS' button for the model to run."),
                                                                             ...
                                                                             tags$li("Once the model finishes running, plots will appear under the different plot tabs beside the 'Model Specification' tab."),
                                                                             br(),
                                                                             actionButton("MPPCA_data_QS", "MPPCA Data", class = "btn-default"),
                                                                             actionButton("MPPCA_model_spec_QS", "Model Specification", class = "btn-default"),
                                                                           )
                                                                         )
                                                                       ),
                                                                       br(),
                                                                ...
                                                                column(width = 6, offset = 0.5,
                                                                       br(),
                                                                       h4(tags$u("Note: MPPCA demo below, click play to animate")),
                                                                       sliderInput("MPPCA_gif_slider", label=NULL, min = 0, max=218, value=0, ticks = FALSE,
                                                                                   animate = animationOptions(interval = 300)),
                                                                       hidden(imageOutput("MPPCA_gif_demo")),
                                                                       br(),
                                                                       br(),
                                                                )
                                                       ...
                                                       tabPanel("MPPCA Data", value = "MPPCA_data",
                                                                br(),
                                                                tabsetPanel(id = "MPPCA_data_tabs",
                                                                            ...
                                                                            tabPanel("Original Data",
                                                                                     value = "MPPCA_original_data_table",
                                                                                     br(),
                                                                                     column(12,
                                                                                            # column(3, "Covariates Highlighted Color", style = "background-color:lightblue; color:blue"),
                                                                                            column(3, "Group Labels Highlighted Color", style = "background-color:orange;"),
                                                                                     ...
                                                                                     uiOutput("MPPCA_original_data_table_UI")
                                                                                     # dataTableOutput("PPCA_original_data_table"),
                                                                                     # tags$style(type="text/css", paste0("#DPPCA_original_data_table td:nth-child(", 3, ") {text-align:center;background-color:green;color: white;text-align:center}"))
                                                                            )
                                                                )
                                                       ),
                                                       tabPanel("Model Specification", value = "MPPCA_specification",
                                                                br(),
                                                                bsCollapse(id = "MPPCA_desc", open = "MPPCA Parameters Description",
                                                                           bsCollapsePanel("MPPCA Parameters Description",
                                                                                           includeHTML("MPPCA_desc_pd.html"),
                                                                                           style = "primary"),
                        ...
                        tabPanel("DPPCA",
                                 ...
                                 conditionalPanel(condition="input.DPPCA_plot_tabs!='DPPCA_steps'",
                                                  ...
                                                  sidebarPanel(width = 3,
                                                               ...
                                                               conditionalPanel(condition="input.DPPCA_plot_tabs=='DPPCA_data'",
                                                                                ...
                                                                                fileInput("DPPCA_input_file", h4("File input:", bsButton("DPPCA_data_tooltip", label = "",
                                                                                          ...
                                                                                          multiple = F, accept = c("text/csv", "text/comma-separated-values, text/plain", ".csv"),
                                                                                          placeholder = "Enter Metabolomic Data Here"),
                                                                                bsPopover("DPPCA_data_tooltip", title="Metabolomic Data File",
                                                                                          content="Should consist of at least the Spectral Data from NMR/MS and a column specifying the different time point. If there are Labels, it should be in the first few columns. This File Input only accepts .txt and .csv",
                                                                                          trigger = "hover"),
                                                                                radioButtons(inputId = 'DPPCA_data_choice', label = NULL,
                                                                                             choiceNames =  c("Use Your Own Data", "Use Example Data"),
                                                                                             choiceValues = c(TRUE, FALSE),
                                                                                             selected = TRUE, inline = TRUE),
                                                               ...
                                                               conditionalPanel(condition="input.DPPCA_plot_tabs=='DPPCA_specification'",
                                                                                ...
                                                                                tabsetPanel(id = "DPPCA_sidetab",
                                                                                            tabPanel("Model Parameters", value = "DPPCA_model_parameters",
                                                                                                     ...
                                                                                                     tags$h6("Click button to run the model using desired parameters:"),
                                                                                                     div(style="display:inline-block",
                                                                                                         disabled(actionButton("DPPCA_submit_para_btn", "Submit Parameters", class = "btn-primary")),
                                                                                                     ),
                                                                                                     # div(style="display:inline-block",
                                                                                                     #     strong(textOutput("MPPCA_optimal_q")),
                                                                                                     # ),
                                                                                                     ...
                                                                                                     #     strong(textOutput("MPPCA_optimal_g")),
                                                                                                     # ),
                                                                                                     p("Please input data first", id="DPPCA_data_check_for_submit", style="color:red"),
                                                                                                     tags$hr(),
                                                                                            ),
                                                               ...
                                                               conditionalPanel(condition="input.DPPCA_plot_tabs!='DPPCA_data' & input.DPPCA_plot_tabs!='DPPCA_specification' & input.DPPCA_plot_tabs!='DPPCA_LMM_modelling' & input.DPPCA_plot_tabs!='DPPCA_steps'",
                                                                                actionButton("DPPCA_return_param", "Return to  Model Specification",
                                                                                             width = "100%", class = "btn-default"),
                                                                                h3(helpText('Graph Controls:')),
                                                                                h3(tags$div(style='color:orange',"As DPPCA takes time to run, this is a pre-run results for plots", id="Pre-run_results_warning")),
                                                                                radioButtons(inputId = 'DPPCA_result_choice', label = NULL,
                                                                                             choiceNames =  c("Use Output Result", "Use Example Result"),
                                                                                             choiceValues = c(TRUE, FALSE),
                                                                                             selected = TRUE, inline = TRUE),
                                 ...
                                 mainPanel(width = 9, id = "DPPCA_main_layout",
                                           # Style for DPPCA tabs
                                           tags$style(HTML("
                                                .tabbable > .nav > li > a[data-value='DPPCA_original'] {background-color:lightyellow}
                                                .tabbable > .nav > li > a[data-value='DPPCA_spectral'] {background-color:lightyellow}
                                                .tabbable > .nav > li > a[data-value='DPPCA_labels'] {background-color:lightyellow}
                                                .tabbable > .nav > li[class=active] > a {background-color:grey; color:white}
                                                ...
                                                #DPPCA_data_tabs li > a[data-value='DPPCA_original_data_table']{background-color:lightgrey}
                                                        ")),
                                           tabsetPanel(id = "DPPCA_plot_tabs", selected = "DPPCA_steps",

                                                       tabPanel("Quick Start", value = "DPPCA_steps",
                                                                column(width = 6, offset = 0.5,
                                                                       br(),
                                                                       h1(strong(tags$u("Usage Guide:"))),
                                                                       h3(
                                                                         tags$div(
                                                                           tags$ol(
                                                                             tags$li("Enter your data in the 'DPPCA Data' tab"),
                                                                             br(),
                                                                             tags$li("Specify the model parameters in the 'Model Specification' tab"),
                                                                             br(),
                                                                             tags$li("In the 'Model Specification' tab, click the 'SUBMIT MODEL SPECIFICATIONS' button for the model to run."),
                                                                             ...
                                                                             tags$li("Once the model finishes running, plots will appear under the different plot tabs beside the 'Model Specification' tab."),
                                                                             br(),
                                                                             actionButton("DPPCA_data_QS", "DPPCA Data", class = "btn-default"),
                                                                             actionButton("DPPCA_model_spec_QS", "Model Specification", class = "btn-default"),
                                                                           )
                                                                         )
                                                                       ),
                                                                       br(),
                                                                ...
                                                                column(width = 6, offset = 0.5,
                                                                       br(),
                                                                       # h4(tags$u("Note: DPPCA demo below, click play to animate")),
                                                                       # sliderInput("DPPCA_gif_slider", label=NULL, min = 0, max=218, value=0, ticks = FALSE,
                                                                       #             animate = animationOptions(interval = 300)),
                                                                       # hidden(imageOutput("DPPCA_gif_demo")),
                                                                       br(),
                                                                       br(),
                                                                )
                                                       ...
                                                       tabPanel("DPPCA Data", value = "DPPCA_data",
                                                                ...
                                                                tabsetPanel(id = "DPPCA_data_tabs",
                                                                            ...
                                                                            tabPanel("Original Data",
                                                                                     ...
                                                                                     br(),
                                                                                     column(12,
                                                                                            column(2, "Time Highlighted Color", style = "background-color:lightgreen;"),
                                                                                            column(3, "Group Labels Highlighted Color", style = "background-color:orange;"),
                                                                                            column(3, "Columns Ignored Highlighted Color", style = "background-color:grey;color:white"),
                                                                                     ),
                                                       ...
                                                       tabPanel("Model Specification", value = "DPPCA_specification",
                                                                column(12, align="center",
                                                                       h2(strong("---Placeholder for DPPCA Explanation---"))
                                                                )
                                                       ),
             ...
             navbarMenu("Sample Size Estimation",
                        ...
                        tabPanel("For PPCA/PPCCA",
                                 conditionalPanel(condition="input.sample_size_PPCA_tab!='sample_size_PPCA_steps'",
                                                  sidebarPanel(width = 3,
                                                               ...
                                                               conditionalPanel(condition="input.sample_size_PPCA_tab=='sample_size_PPCA_pilot_data'",
                                                                                ...
                                                                                fileInput("sample_size_PPCA_pilot_data", h4("File input:", bsButton("sample_size_PPCA_pilot_data_tooltip", label = "",
                                                                                          ...
                                                                                          multiple = F, accept = c("text/csv", "text/comma-separated-values, text/plain", ".csv"),
                                                                                          placeholder = "Enter Metabolomic Data Here"),
                                                                                bsPopover("sample_size_PPCA_pilot_data_tooltip", title="Metabolomic Data File",
                                                                                          content="Should consist of at least the Spectral Data from NMR/MS. If there are Labels, it should be in the first few columns. This File Input only accepts .txt and .csv",
                                                                                          trigger = "hover"),
                                                                                radioButtons(inputId = 'sample_size_PPCA_data_choice', label = NULL,
                                                                                             choiceNames =  c("Use Your Own Data", "Use Example Data"),
                                                                                             choiceValues = c(TRUE, FALSE),
                                                                                             selected = TRUE, inline = TRUE),
                                                               ...
                                                               conditionalPanel(condition="input.sample_size_PPCA_tab=='sample_size_PPCA_specification'",

                                                                                actionButton("sample_size_PPCA_pilot_data_button", "Go to Pilot Data",
                                                                                             width = "100%", class = "btn-default"),

                                                                                h3(helpText("Sample Size Estimation Parameters:")),
                                                                                hr(),

                                                                                h4("Do you want to include Pilot Data?"),
                                                                                checkboxInput(inputId = 'sample_size_PPCA_pilot_check', label = 'Tick for Yes', value = FALSE),
                                                                                ...
                                                                                hidden(p("Pilot Data Selected but not Given", id="sample_size_PPCA_data_check_for_submit", style="color:red")),

                                                               ),
                                                               conditionalPanel(condition="input.sample_size_PPCA_tab!='sample_size_PPCA_pilot_data' & input.sample_size_PPCA_tab!='sample_size_PPCA_specification' & input.sample_size_PPCA_tab!='sample_size_PPCA_steps'",
                                 ...
                                 mainPanel(width = 9, id = "sample_size_PPCA_main_layout",
                                   # Style for data tabs
                                   tags$style(HTML("
                                                .tabbable > .nav > li > a[data-value='sample_size_PPCA_spectral'] {background-color:lightyellow}
                                                .tabbable > .nav > li > a[data-value='sample_size_PPCA_covariates'] {background-color:lightyellow; color:blue}
                                                # .tabbable > .nav > li > a[data-value='PPCA_labels'] {background-color:lightyellow}
                                                .tabbable > .nav > li[class=active] > a {background-color:grey; color:white}
                                                          ")),

                                   tabsetPanel(id="sample_size_PPCA_tab", selected = "sample_size_PPCA_steps",

                                               tabPanel("Quick Start", value = "sample_size_PPCA_steps",
                                                        column(width = 6, offset = 0.5,
                                                               br(),
                                                               h1(strong(tags$u("Usage Guide:"))),
                                                               h3(
                                                                 tags$div(
                                                                   tags$ol(
                                                                     h4(helpText("(optional) If you have pilot data, you may enter them in the 'Pilot Data' tab")),
                                                                     tags$li("Specify the model parameters in the 'Model Specification' tab"),
                                                                     br(),
                                                                     tags$li("In the 'Model Specification' tab, click the 'Calculate Sample Size' button for the model to run."),
                                                                     br(),
                                                                     tags$li("Once the model finishes running, plots will appear under the different plot tabs beside the 'Model Specification' tab."),
                                                                     br(),
                                                                     actionButton("sample_size_PPCA_data_QS", "Pilot Data", class = "btn-default"),
                                                                     actionButton("sample_size_PPCA_model_spec_QS", "Model Specification", class = "btn-default"),
                                                                   )
                                                                 )
                                                               ),
                                                               br(),
                                                        ...
                                                        column(width = 6, offset = 0.5,
                                                               br(),
                                                               # h4(tags$u("Note: Sample Size Estimation demo below, click play to animate")),
                                                               # sliderInput("sample_size_PPCA_gif_slider", label=NULL, min = 0, max=218, value=0, ticks = FALSE,
                                                               #             animate = animationOptions(interval = 300)),
                                                               # hidden(imageOutput("sample_size_PPCA_gif_demo")),
                                                               br(),
                                                               br(),
                                                        )
                                               ...
                                               tabPanel("Model Specification", value = "sample_size_PPCA_specification",
                                                        br(),
                                                        column(12, align="center",
                                                               h2(strong("---Placeholder for Sample Size Explanation---"))
                                                        )
